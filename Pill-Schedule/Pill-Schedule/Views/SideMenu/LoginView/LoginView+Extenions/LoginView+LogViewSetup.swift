...
extension LogInView {
    ...
    func setupLoginConstrsaints() {
        ...
        emailTextField.snp.makeConstraints { make in
            make.width.equalTo(promptLabel).multipliedBy(3.2)
        ...
        passwordTextFieldLabel.snp.makeConstraints { make in
            ...
            make.width.equalTo(continueButton).multipliedBy(2)
        }
